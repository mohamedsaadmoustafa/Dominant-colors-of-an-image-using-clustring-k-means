...
class Model:
    ...
    def percentages_dominant_colors(self, flatten_image, cluster_centers, labels):
        ...
        self.percentages_dominant_df['HexaColor'] = self.percentages_dominant_df['Color'].map(
            lambda a: HexaColor(a))
    ...
    def visualize_colors_on_image(self):
        BAR_HEIGHT, BAR_WIDTH = self.original_image.shape[0], int(
            self.original_image.shape[1] // 7.0)
    ...
    def visualize_colors_pie(self):
        ...
        fig, ax = plt.subplots(figsize=(90, 90), dpi=10, facecolor='#e1ecdb')
    ...
    def final(self):
        ...
        self.percentages_dominant_colors(
            flatten_image, cluster_centers, labels)
        image_colors_on_image = self.visualize_colors_on_image()
        image_colors_pie = self.visualize_colors_pie()
        # image_colors_boxes, image_colors_on_image, image_colors_pie
        return image_colors_on_image, image_colors_pie
